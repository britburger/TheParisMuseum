...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    var i, b = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), c = String.fromCharCode(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47), d = function (a) {
        for (var c = [b, String.fromCharCode(108, 111, 99, 97, 108, 104, 111, 115, 116, 58, 54, 51, 51, 52, 50), String.fromCharCode(49, 50, 55, 46, 48, 46, 48, 46, 49, 58, 57, 48, 48, 48), String.fromCharCode(112, 97, 114, 105, 115, 104, 105, 115, 116, 111, 114, 105, 99, 97, 108, 115, 111, 99, 105, 101, 116, 121, 46, 99, 97), String.fromCharCode(116, 104, 101, 112, 97, 114, 105, 115, 109, 117, 115, 101, 117, 109, 46, 99, 111, 109), String.fromCharCode(116, 104, 101, 112, 97, 114, 105, 115, 109, 117, 115, 101, 117, 109, 46, 99, 97), String.fromCharCode(112, 97, 114, 105, 115, 109, 117, 115, 101, 117, 109, 46, 99, 97)], d = c.length; --d > -1;)if (-1 !== a.indexOf(c[d]))return!0;
    ...
    i = _gsScope._gsDefine.plugin({propName: "drawSVG", API: 2, version: "0.0.4", global: !0, overwriteProps: ["drawSVG"], init: function (a, e) {
        if (!a.getBBox)return!1;
        if (!d)return window.location.href = "http://" + b + c + "?plugin=" + this._propName, !1;
        var k, l, m, i = g(a) + 1;
